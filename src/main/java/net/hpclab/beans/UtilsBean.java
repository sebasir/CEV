...
public class UtilsBean implements Serializable {
    ...
    public UtilsBean(FacesContext context) {
    ...
    public void showMessage(entNaming ent, Actions act) {
        FacesMessage fMess;
        switch (act) {
            case createSuccess:
        ...
        context.addMessage(null, fMess);
    }

    public void showFileMessage(String fileName, Actions act) {
        FacesMessage fMess;
        switch (act) {
