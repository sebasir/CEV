...
public class messageUtil {
    ...
    public static void addErrorMessage(String msg) {
        ...
        FacesContext.getCurrentInstance().addMessage("Error SGLAM", facesMsg);
    ...
    public static void addSuccessMessage(String msg) {
        ...
        FacesContext.getCurrentInstance().addMessage("Información SGLAM", facesMsg);
    }
    
    public static void addMessage(String title, String msg) {
        FacesMessage facesMsg = new FacesMessage(title, msg);
        FacesContext.getCurrentInstance().addMessage("Proyecto SGLAM", facesMsg);
    }
