...
COMMENT ON TYPE STATUS_ENUM IS 'Enumeraci�n que define los estados posibles de todas las tablas.';

CREATE TYPE AUDIT_ENUM AS ENUM ('LOGIN', 'LOGOUT', 'INSERT', 'UPDATE', 'DELETE', 'STATUS_CHANGE');
COMMENT ON TYPE AUDIT_ENUM IS 'Enumeraci�n que define las operaciones posibles del sistema.';
...
COMMENT ON TABLE COLLECTION IS 'Tabla para guardar las colecciones, tales que pertenezcan a cada instituci�n.';
...
COMMENT ON TABLE CATALOG IS 'Tabla para guardar los catálogos donde yacen los especímenes, para cada colecci�n.';
...
COMMENT ON TABLE MODULES IS 'Tabla para guardar los m�dulos del sistema.';
...
COMMENT ON TABLE MODULES_USERS IS 'Tabla para guardar las operaciones de usuarios en los modulos, con fecha, direccion IP, acci�n realizada y cambio.';